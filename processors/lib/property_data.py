...
PROPERTY_NORMALIZE = {
    ...
    "sks habitat": "SKS Habitat",
    "sks habitat residence": "SKS Habitat",
    "arc austin hills": "ARC Austin Hills",
    "pinnacle tower": "Pinnacle Tower",
    "vksl residence": "KSL Residence",   # 中介笔误
